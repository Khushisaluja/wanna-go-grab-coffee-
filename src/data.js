  ...
  solutions: [
    {
      ...
      pointers: ['bank name gets the verified tick, the shop name doesn’t', 'first-time payee? it tells you what matches', 'a scam call in progress gets named on screen'],
    },
    {
      id: 'smartpay',
    ...
    },
    {
      ...
      pointers: ['“12 days left · on pace”, not a scary total', 'goals count money already in your bank', 'points come from habits, not from spending more'],
    },
    {
      id: 'yours',
      title: 'an app that shapes itself around *you*',
      body: 'one question at setup and the home screen arranges itself. long-press anything to move it or hide it. still dead simple.',
      screens: ['/img/tally/cs-home.png', '/img/tally/cs-arrange.png'],
      pointers: ['home is a stack of widgets you own', 'arrows too, if dragging isn’t your thing', 'setup went from seven screens to four'],
    },
  ],
